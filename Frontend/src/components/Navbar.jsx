...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-white dark:text-black fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-300  dark:bg-white dark:text-black  duration-300 transition-all ease-in-out"
          : ""}`}
      >
        ...
        <div className="navbar">
          ...
          <div className="navbar-end space-x-3">
            ...
            {authUser?<Logout />:
            <div className="">
            <a className="btn bg-black text-white dark:bg-white hover:bg-white hover:text-black  dark:text-black dark:hover:bg-black dark:hover:text-white"
